...
public class AccountLookupController {
	...
	public ResponseEntity<AccountLookupResponse> getAllAccounts() {
		try {
			...
			final var safeErrorMessage = "Failed to complete get all accounts request!";
	...
	public ResponseEntity<AccountLookupResponse> getAccountById(@PathVariable(value = "id") final String id) {
		try {
			...
			final var safeErrorMessage = "Failed to complete get accounts by ID request!";
			logger.log(Level.SEVERE, safeErrorMessage, e);
			return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<AccountLookupResponse> getAccountByHolder(@PathVariable(value = "accountHolder") final String accountHolder) {
		try {
			...
			final var safeErrorMessage = "Failed to complete get accounts by holder request!";
			logger.log(Level.SEVERE, safeErrorMessage, e);
			return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<AccountLookupResponse> getAccountWithBalance(
		@PathVariable(value = "equalityType") final EqualityType equalityType,
		@PathVariable(value = "balance") final double balance
	) {
		try {
			...
			final var safeErrorMessage = "Failed to complete get accounts with balance request!";
			logger.log(Level.SEVERE, safeErrorMessage, e);
			return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
